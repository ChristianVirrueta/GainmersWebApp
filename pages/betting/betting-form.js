            ...
            return ( < div >
...

                {
                    this.state.checked1 ? ( <
                        ...
                        value = { this.state.checked1Contribution } onChange = {
                            event => this.setState({
...

                {
                    this.state.checked2 ? ( <
                        ...
                        Input className = "miInput"
                        placeholder = 'Value in Ether'
                        value = { this.state.checked2Contribution } onChange = {
                            event => this.setState({
...

                {
                    this.state.checked3 ? ( <
                        ...
                        Input className = "miInput"
                        placeholder = 'Value in Ether'
                        value = { this.state.checked3Contribution } onChange = {
                            event => this.setState({
...

                {
                    this.state.checked4 ? ( <
                        ...
                        Input className = "miInput"
                        placeholder = 'Value in Ether'
                        value = { this.state.checked4Contribution } onChange = {
                            event => this.setState({
...

                {
                    this.state.checked5 ? ( <
                        ...
                        Input className = "miInput"
                        placeholder = 'Value in Ether'
                        value = { this.state.checked5Contribution } onChange = {
                            event => this.setState({
...

                {
                    this.state.checked6 ? ( <
                        ...
                        Input className = "miInput"
                        placeholder = 'Value in Ether'
                        value = { this.state.checked6Contribution } onChange = {
                            event => this.setState({
...

                {
                    this.state.checked7 ? ( <
                        ...
                        Input className = "miInput"
                        placeholder = 'Value in Ether'
                        value = { this.state.checked7Contribution } onChange = {
                            event => this.setState({
...

                {
                    this.state.checked8 ? ( <
                        ...
                        Input className = "miInput"
                        placeholder = 'Value in Ether'
                        value = { this.state.checked8Contribution } onChange = {
                            event => this.setState({
...

                {
                    this.state.checked9 ? ( <
                        ...
                        Input className = "miInput"
                        placeholder = 'Value in Ether'
                        value = { this.state.checked9Contribution } onChange = {
                            event => this.setState({
...

                {
                    this.state.checked10 ? ( <
                        ...
                        Input className = "miInput"
                        placeholder = 'Value in Ether'
                        value = { this.state.checked10Contribution } onChange = {
                            event => this.setState({
...

                {
                    this.state.checked11 ? ( <
                        ...
                        Input className = "miInput"
                        placeholder = 'Value in Ether'
                        value = { this.state.checked11Contribution } onChange = {
                            event => this.setState({
...

                {
                    this.state.checked12 ? ( <
                        ...
                        Input className = "miInput"
                        placeholder = 'Value in Ether'
                        value = { this.state.checked12Contribution } onChange = {
                            event => this.setState({
                ...
                checked = { this.state.conditionsAccepted } label = 'Accept terms and conditions'
                ...
                <Grid>
                    ...
                    <Grid.Row columns='2' divided>
                            ...
                            <Container text>    
                                ...
                                <div >
                                <Flag style={{padding: '10px'}} className={'Peru'} />{this.props.country1} 
                                <span>   VS</span>
                                <Flag style={{padding: '10px'}} className={'Brazil'} />{this.props.country2}
                                </div>
                            </Container>
                            </Grid.Column >
